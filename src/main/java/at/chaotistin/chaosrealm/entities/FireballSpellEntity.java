...
public class FireballSpellEntity extends ProjectileItemEntity {
    public FireballSpellEntity(EntityType<? extends FireballSpellEntity> p_i50159_1_, World p_i50159_2_) {
        super(p_i50159_1_, p_i50159_2_);
    }

    public FireballSpellEntity(World worldIn, LivingEntity throwerIn) {
        super(EntityType.SNOWBALL, throwerIn, worldIn);
    }

    public FireballSpellEntity(World worldIn, double x, double y, double z) {

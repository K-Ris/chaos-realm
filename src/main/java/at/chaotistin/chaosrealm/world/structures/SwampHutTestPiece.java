...
import at.chaotistin.chaosrealm.entities.GnollEntity;
...
public class SwampHutTestPiece extends ScatteredStructurePiece {
    private boolean witch;
    private boolean field_214822_f;

    public SwampHutTestPiece(Random random, int x, int z) {
        super(IStructurePieceType.TESH, random, x, 64, z, 7, 7, 9);
    }

    public SwampHutTestPiece(TemplateManager p_i51340_1_, CompoundNBT p_i51340_2_) {
        ...
        if (!this.isInsideBounds(worldIn, structureBoundingBoxIn, 0)) {
            ...
            if (!this.witch) {
                ...
                if (structureBoundingBoxIn.isVecInside(new BlockPos(l, i1, k))) {
                    this.witch = true;
                    GnollEntity witchentity = (GnollEntity) MobEntities.GNOLL.create(worldIn.getWorld());
    ...
    private void func_214821_a(IWorld p_214821_1_, MutableBoundingBox p_214821_2_) {
        if (!this.field_214822_f) {
            ...
            if (p_214821_2_.isVecInside(new BlockPos(i, j, k))) {
                ...
                HyenaEntity catentity = (HyenaEntity) MobEntities.HYENA.create(p_214821_1_.getWorld());
